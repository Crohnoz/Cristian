...
(() => {
  ...
  Promise.resolve()
    ...
    .then(async () => {
      ...
      if (file === 'index.html' || file === 'lab.html') {
      ...
      setTimeout(() => {
        if (!['index.html','lab.html'].includes(file)) document.querySelectorAll('a[href="./index.html"]').forEach(link => { link.href = './dashboard.html'; });
